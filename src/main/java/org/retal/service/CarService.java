...
/**
 * Service, containing business-logic methods regarding {@linkplain org.retal.domain.Car Car}
 * entities.
 * 
...
public class CarService {
   ...
   * 
   * @param car {@linkplain org.retal.domain.Car Car} to be added
   ...
   * 
   * @param car {@linkplain org.retal.domain.Car Car} to be validated
   * @param bindingResult object to store validation result
