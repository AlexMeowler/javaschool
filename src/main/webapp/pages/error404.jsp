	...
	<div class="container main-body">
		<div class="row">
			<div class="col-lg-4 col-md-4 col-sm-12">
				<img src="<c:url value="static/sadcat.jpg"/>" alt="crying cat face" alt="crying cat face" width="350" height="197">
			</div>
			<div class="col-lg-8 col-md-8 col-sm-12 desc">
				<h2>Resource not found</h2>
				<p>If you see this page, then resource you tried to access doesn't exist.</p>
